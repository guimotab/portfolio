...
const AboutMe = () => {
    ...
    return (
        <section id="about_me" className="flex flex-col items-center w-full mt-10 bg-white shadow-gray-400 shadow-lg px-10 py-5 rounded-md">
                    ...
                    <div className="row-span-2 relative flex gap-3">
                        <div className="grid grid-rows-3 z-10">
                            <div className="relative top-1 h-full">
                                <div className="p-1.5 border-4 border-cor-terciaria bg-white rounded-full"></div>
                            </div>
                        ...
                        <div className="absolute h-full w-1.5 bg-cor-terciaria ml-[6px] my-2"></div>
                        <div className="flex flex-col justify-between">
                            <div>
                                <h2 className="font-bold text-lg">Ensino Médio | Colégio Adventista de Porto Velho</h2>
                                <p className="font-medium">01/2020 - 12/2022</p>
                            </div>
                            <div>
                                <h2 className="font-bold text-lg">Análise e Desenvolvimento de Sistemas | IFRO </h2>
                                <p className="font-medium">01/2023 - cursando atualmente</p>
                            </div>
                            <div>
                                <h2 className="font-bold text-lg">Curso Alura</h2>
                                <p className="font-medium">01/2023 - cursando atualmente</p>
                            </div>
                        </div>
                    </div>
