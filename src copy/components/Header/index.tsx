      ...
      <div className="flex items-center justify-between w-full max-w-7xl">
        <div className="flex items-center gap-5">
          ...
          <div className="relative w-7 h-7">
            <div id="divWhiteMode" className="hidden dark:block" onClick={event => changeTheme("white")}>
              <BsFillSunFill id="themeWhite" className="text-primary z-10 w-8 h-8 md:w-7 md:h-7 dark:text-cor-darkTerciaria " />
            </div>
            <div id="divDarkMode" className="cursor-pointer dark:hidden" onClick={event => changeTheme("dark")}>
              <BsMoonFill id="themeDark" className="text-primary z-10 w-7 h-7 md:w-6 md:h-6 dark:text-cor-darkTerciaria cursor-pointer" />
            </div>
          </div>
        ...
        <div className="flex gap-6 md:gap-3">
          <a href="https://github.com/guimotab" target="_blank">
            <BsGithub className="w-8 md:w-6 h-8 md:h-6 text-gray-500 hover:text-secondary dark:text-cor-darkTerciaria dark:hover:text-cor-darkHover" />
          </a>
          <a href="https://www.linkedin.com/in/guimotab/" target="_blank">
            <BsLinkedin className="w-8 md:w-6 h-8 md:h-6 text-gray-500 hover:text-secondary dark:text-cor-darkTerciaria dark:hover:text-cor-darkHover" />
          </a>
          <a href="https://wa.me/5569992687447" target="_blank">
            <BsWhatsapp className="w-8 md:w-6 h-8 md:h-6 text-gray-500 hover:text-secondary dark:text-cor-darkTerciaria dark:hover:text-cor-darkHover" />
          </a>
        </div>
      </div>
    </header>
