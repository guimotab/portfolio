        ...
        <section id='contacts' className="flex flex-col w-full py-3 mb-10 gap-3">
            ...
            <div className='flex gap-1'>
                ...
                <div className='flex flex-col gap-3 py-2'>
                    <a href="https://wa.me/5569992687447" className="flex items-center gap-3"  rel="noreferrer" target='_blank' >
                    ...
                    <a href="https://www.linkedin.com/in/guimotab/" className="flex items-center gap-3" rel="noreferrer"  target='_blank' >
                        <BsLinkedin className='w-7 h-7 dark:text-gray-200' />
                        <p className='font-medium text-lg dark:text-gray-200'>linkedin/in/guimotab</p>
                    </a>
                    <a href='https://github.com/guimotab' rel="noreferrer"  target='_blank' className="flex items-center gap-3">
