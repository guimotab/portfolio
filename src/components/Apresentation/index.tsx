...
const Apresentation = () => {
    const logos = [
        {
            jsx: <BiLogoJavascript className="row-start-2 w-12 h-12 text-gray-400 hover:text-cor-secundaria dark:text-gray-200 dark:hover:text-cor-darkHover" />,
            ...
            jsx: <BiLogoTypescript className="row-start-2 w-12 h-12 text-gray-400 hover:text-cor-secundaria dark:text-gray-200 dark:hover:text-cor-darkHover" />,
            ...
            jsx: <BiLogoCss3 className="row-start-2 w-12 h-12 text-gray-400 hover:text-cor-secundaria dark:text-gray-200 dark:hover:text-cor-darkHover" />,
            ...
            jsx: <BiLogoHtml5 className="row-start-2 w-12 h-12 text-gray-400 hover:text-cor-secundaria dark:text-gray-200 dark:hover:text-cor-darkHover" />,
            ...
            jsx: <BiLogoReact className="row-start-2 w-12 h-12 text-gray-400 hover:text-cor-secundaria dark:text-gray-200 dark:hover:text-cor-darkHover" />,
            ...
            jsx: <BiLogoJava className="row-start-2 w-12 h-12 text-gray-400 hover:text-cor-secundaria dark:text-gray-200 dark:hover:text-cor-darkHover" />,
            ...
            jsx: <BiLogoTailwindCss className="row-start-2 w-12 h-12 text-gray-400 hover:text-cor-secundaria dark:text-gray-200 dark:hover:text-cor-darkHover" />,
            ...
            jsx: <BiLogoGit className="row-start-2 w-12 h-12 text-gray-400 hover:text-cor-secundaria dark:text-gray-200 dark:hover:text-cor-darkHover" />,
            ...
            jsx: <BiLogoMongodb className="row-start-2 w-12 h-12 text-gray-400 hover:text-cor-secundaria dark:text-gray-200 dark:hover:text-cor-darkHover" />,
