const AboutMe = () => {
    ...
    return (
        <section id="about_me" className="flex flex-col items-center w-full mt-10 bg-white dark:bg-primary shadow-gray-400 dark:shadow-none shadow-lg px-10 py-6 rounded-md">
