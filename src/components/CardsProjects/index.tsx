...
const CardsProjects = ({ imageProject, altProject, title, subtitle, linkViewProject, linkViewCode, logosTechnologies, support, setOpenImage }: CardsProjectsProps) => {
    ...
    return (
        <div className="flex flex-col gap-4 border w-full border-cor-terciaria h-full rounded-lg bg-white dark:bg-cor-terciaria px-8 py-4 shadow-gray-600 dark:shadow-none shadow-lg opacity-60 hover:opacity-100 hover:animate-growProjects">
