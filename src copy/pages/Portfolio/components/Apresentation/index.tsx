    ...
    return (
        <section className="flex flex-col items-center w-full max-w-5xl mt-8">
            <div className="flex flex-col md:flex-row self-center items-center gap-5">
                <img src="../images/eu.jpg" alt="Minha Imagem" className="w-full max-w-[15rem] rounded-full border-2 border-primary dark:border-cor-darkTerciaria" />
                <div className="flex flex-col items-center md:items-start min-w-fit">
                    ...
                    <p
                        ...
                        className="font-medium px-3 py-1 mt-2 bg-primary dark:bg-cor-darkSecundaria dark:hover:bg-cor-darkHover w-fit cursor-pointer text-white rounded-md hover:bg-cor-hover">
                        Meus Projetos
                    </p>
                </div>
            </div>
